...
from app.utils import calcular_riesgo_y_recomendaciones, enviar_alerta_telegram
...
async def analizar_audio_forense(
    ...
    try:
        ...
        # =====================================================
        # PERSISTENCIA FORENSE EN CALIENTE Y TELEGRAM
        # =====================================================
        try:
        ...
        chat_destinatario = telegram_chat_id if telegram_chat_id else settings.TELEGRAM_CHAT_ID
        riesgo_nivel = str(analisis_riesgo.get("nivel_evaluacion", "")).upper()
        
        if "CRÍTICO" in riesgo_nivel or "ALTO" in riesgo_nivel or "CRITICO" in riesgo_nivel or telegram_chat_id:
            enviar_alerta_telegram(
                file.filename, 
                analisis_riesgo["nivel_evaluacion"], 
                analisis_riesgo["recomendaciones"],
                tipo_origen,
                chat_destinatario
            )
